...
Requires [GraphicsMagick](../commands/http://www.graphicsmagick.org/download.html)
and [Tesseract](../commands/https://github.com/tesseract-ocr/tesseract/wiki/Downloads).
...
### [Select Nth Item](../commands/select-nth-item-global.ini)
...
By default, this command launches [Beyond Compare 4](../commands/https://www.scootersoftware.com/download.php)
for doing the comparison.
You can find examples of launching other tools like [WinMerge](../commands/https://winmerge.org/downloads) directly in the command's source code.

### [Convert Markdown to ...](../commands/convert-markdown.ini)

Converts text written in [Markdown syntax](../commands/https://daringfireball.net/projects/markdown/syntax)
to desired format, which can be for example:

* HTML
* [Jira markup](../commands/https://jira.atlassian.com/secure/WikiRendererHelpAction.jspa?section=all)
* JSON (AST) (JSON representation of the parsed text; useful rather for contributors than users)
* [LaTeX](../commands/https://en.wikipedia.org/wiki/LaTeX)
...
This script relies on the [mistletoe](../commands/https://github.com/miyuchina/mistletoe) project to do the
actual Markdown parsing and conversion.
This in turn requires that [Python](../commands/https://www.python.org/downloads/) is installed on the user computer.
...
![Show Character Code Dialog](../commands/images/cmd_show-char-code.png)
