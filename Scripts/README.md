...
- [kdotool](../commands/https://github.com/jinliu/kdotool) for getting window titles on KDE
- [ydotool](../commands/https://github.com/ReimuNotMoe/ydotool) for copy/paste commands
- [gnome-screenshot](../commands/https://gitlab.gnome.org/GNOME/gnome-screenshot) for
  taking screenshots in Gnome
- [grim](../commands/https://github.com/emersion/grim) and
  [slurp](../commands/https://github.com/emersion/slurp) for taking screenshots in Sway and
  Hyprland
- [spectacle](../commands/https://invent.kde.org/graphics/spectacle) for screenshots in
  other environments
