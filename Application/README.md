...
This works great along the script [show window title](../commands/../Automatic/show-window-title.ini) which saves source window title to tags while adding to clipboard.  
...
Passes text to [Google Translate](../commands/https://translate.google.com/).
...
Requires [qrcode](../commands/https://github.com/lincolnloop/python-qrcode) utility.
